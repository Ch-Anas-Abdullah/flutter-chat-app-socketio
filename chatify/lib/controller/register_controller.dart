...
import 'package:chatify/const_files/country_list.dart';
...
import 'package:chatify/view/screens/register_section/otp_enter_screen.dart';
...
class RegisterController extends GetxController {
  ...
  Rx<Datum> selectedCountry = Datum(
          flag: countryModel.data[167].flag,
          name: countryModel.data[167].name,
          code: countryModel.data[167].code,
          dialCode: countryModel.data[167].dialCode)
      .obs;
  ...
  Future<void> phoneAuth() async {
    codeVerificationId = "123456";
    Get.to(() =>
        OTPEnterScreen(phoneNumber: phoneNumber.text, dialCode: dialCode.text));
